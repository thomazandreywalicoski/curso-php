                ...
                <?php 
                    ...
                    ?>
                        ...
                        <div class="dados-produto">
                            <div class="informacao-produto"><?php echo $produto['id'] ?></div>
                            <div><?php echo $produto['nome'] ?></div>
                            <div><?php echo $produto['categoria'] ?></div>
                            <div><?php echo $produto['quantidade'] ?></div>
                            <div><?php echo "R$" . $preco ?></div>
                            <div><?php echo $validade ?></div>
                            <div><?php echo $produto['estoque'] ?></div>
                            <div></div>
                        </div>
